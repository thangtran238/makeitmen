...
<body>
  ...
  <div class="table-actions">
    ...
    <a href="/project/makeitman/app/Views/admin/revenue/pages/day.php">Next Page</a>
  </div>
</body>
</html>
...
function getOrderInMonth() {
  ...
  $time = getTime();
  $lastMonthStartDay = $time['last_month']['start'];
  $lastMonthEndDay = $time['last_month']['end'];
  ...
  <tr>
    ...
    <p><?php echo $lastMonthStartDay,$lastMonthEndDay  ?></p>
<?php }
}
