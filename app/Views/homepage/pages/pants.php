...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="search-bar">
        <form id="searchForm" action="/makeitman/app/Views/homepage/pages/php/pants.php" method="post">
      ...
      <div class="side-bar">
        <div class="tag">
          <ul>
            ...
            <li class="active"><a href="./pants.php"><span class="sub-color">#</span>Pants</a></li>
  ...
  <script src="./js/pages/pants.js"></script>
