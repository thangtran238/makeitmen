...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="search-bar">
        <form id="searchForm" action="/makeitman/app/Views/homepage/pages/php/sneakers.php" method="post">
      ...
      <div class="side-bar">
        <div class="tag">
          <ul>
            ...
            <li class="active"><a href="./sneakers.php"><span class="sub-color">#</span>Sneakers</a></li>
  ...
  <script src="./js/pages/sneakers.js"></script>
