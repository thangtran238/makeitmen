...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="search-bar">
        <form id="searchForm" action="/makeitman/app/Views/homepage/pages/php/accessory.php" method="post">
      ...
      <div class="side-bar">
        <div class="tag">
          <ul>
            ...
            <li><a href="./t-shirt.php"><span class="sub-color">#</span>T-shirt</a></li>
            <li><a href="./pants.php"><span class="sub-color">#</span>Pants</a></li>
            <li><a href="./sneakers.php"><span class="sub-color">#</span>Sneakers</a></li>
            <li class="active"><a href="./accessory.php"><span class="sub-color">#</span>Accessories</a></li>
  ...
  <script src="./js/pages/accessory.js"></script>
