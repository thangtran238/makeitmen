...
if (isset($_GET['idinreament']) && isset($_GET['req'])) {
        ...
        <div class="header">
            <div class="cart_title">
                <div class="cart_name">
                    ...
                    <h3>Shopping Cart</h3>
                    <a href="../homepage.php"><i class="fa fa-cart-plus"></i></a>
                </div>
            </div>
            <div class="cart_user">
                <div class="user_name">
                ...
                <div class="logout"><a href="../homepage.php"><i class="fa-solid fa-arrow-right-from-bracket"></i></a></div>
            </div>
        </div>
        <?php
                    ...
                    <div class="content">
                        <div class="frame-product-list">
                            <div class="product_cart">
                                ...
                                <div class="img"><img src="/project/makeitman/public/img/<?php echo $value["img"] ?>" alt=""></div>
                                ...
                                <div class="amount_total"><?php echo $value["qty"] * $value['price'];
                                                            $total = 0;
                                                            $total += $value["qty"] * $value['price']; ?></div>
                            </div>
                        </div>
                    </div>
                <?php
