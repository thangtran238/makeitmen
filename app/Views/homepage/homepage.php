...
<link rel="stylesheet" href="../homepage/assets/style/overall.css" />
<link rel="stylesheet" href="../homepage/assets/style/homepage/header.css" />
<link rel="stylesheet" href="../homepage/assets/style/homepage/content.css" />
<link rel="stylesheet" href="../homepage/assets/style/homepage/modal.css" />
<link rel="stylesheet" href="../homepage/assets/style/homepage/cart.css" />
<link rel="stylesheet" href="../homepage/assets/style/homepage/footer.css" />
</head>
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="search-bar">
        <form id="searchForm" action="/makeitman/app/Views/homepage/assets/php/search.php" method="post">
    ...
    <div class="content">
      <div class="side-bar">
        <div class="tag">
          <ul>
            <li class="active"><a href="./homepage.php">All</a></li>
            <li><a href="./pages/t-shirt.php"><span class="sub-color">#</span>T-shirt</a></li>
            <li><a href="./pages/pants.php"><span class="sub-color">#</span>Pants</a></li>
            <li><a href="./pages/Sneakers.php"><span class="sub-color">#</span>Sneakers</a></li>
            <li><a href="./pages/accessory.php"><span class="sub-color">#</span>Accessories</a></li>
  ...
  <script src="../homepage/assets/js/search.js"></script>
  <script src="../homepage/assets/js/userRow.js"></script>
